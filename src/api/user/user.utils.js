...
/* Token */
export const signToken = (id) => jwt.sign({ id }, process.env.SECRET_KEY);
...
export const getUser = async (token) => {
  try {
    ...
    console.log("Error @getUser - user_user.utils: ", error.message);
...
*/
const REGEXP =
  /^[0-9a-zA-Z_.가-힣\u0600-\u06FF\u0750-\u077F\u3040-\u309F\u30A0-\u30FF\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0100-\u024F\u0370-\u04FF\u4E00-\u9FFF]*$/;
